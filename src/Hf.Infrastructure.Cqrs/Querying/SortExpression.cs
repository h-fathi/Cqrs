...
namespace Hf.Cqrs.Infrastructure.Querying
{
    public class SortExpression
    {
        ...
        private static readonly Regex _regex = new Regex(ExpressionPattern, RegexOptions.Compiled | RegexOptions.IgnoreCase,
        ...
        {
            if (!obj.Equals(typeof(SortExpression))) return false;

            SortExpression sort = (SortExpression)obj;
